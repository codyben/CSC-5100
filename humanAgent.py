...
class HumanAgent(object):
    def __init__(self, vehicle, target_speed=20, opt_dict={}):
        ...
        if behavior == "normal":
            ...
            opt_dict['sampling_resolution'] = 2.0
            opt_dict['base_tlight_threshold'] = 5.0
            opt_dict['base_vehicle_threshold'] = 5.0
            opt_dict['max_brake'] = 0.5
        elif behavior == "cautious":
            opt_dict['ignore_traffic_lights'] = False
            opt_dict['ignore_stop_signs'] = False
            opt_dict['ignore_vehicles'] = False
            opt_dict['sampling_resolution'] = 1.0
            opt_dict['base_tlight_threshold'] = 2.0
            opt_dict['base_vehicle_threshold'] = 2.0
            opt_dict['max_brake'] = 0.8
        elif behavior == "aggressive":
            opt_dict['ignore_traffic_lights'] = False
            opt_dict['ignore_stop_signs'] = False
            opt_dict['ignore_vehicles'] = False
            opt_dict['sampling_resolution'] = 5.0
            opt_dict['base_tlight_threshold'] = 7.0
            opt_dict['base_vehicle_threshold'] = 7.0
            opt_dict['max_brake'] = 0.3
        else:
            opt_dict['ignore_traffic_lights'] = True
            opt_dict['ignore_stop_signs'] = True
            opt_dict['ignore_vehicles'] = True
            opt_dict['sampling_resolution'] = 10.0
            opt_dict['base_tlight_threshold'] = 10.0
            opt_dict['base_vehicle_threshold'] = 10.0
            opt_dict['max_brake'] = 0.2
